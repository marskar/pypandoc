...
module_dir = os.path.join(__location__, "../src/pypandoc")
...
try:
    from pypandoc import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'pypandoc-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'pypandoc Documentation',
