...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"pypandoc","description":"A binder-enabled repo for making HTML slides using pypandoc."}'
	test -f README.rst || echo "pypandoc" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/pypandoc.git
